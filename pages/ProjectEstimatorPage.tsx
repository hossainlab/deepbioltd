...
import { ChevronLeftIcon, SparklesIcon, CheckCircleIcon } from '../components/icons/Icons.tsx';
...
const serviceOptions = {
  'bulk-rna-seq': { name: 'Bulk RNA-Seq Analysis', questions: ['sampleCount', 'organism'] as const },
  'single-cell-rna-seq': { name: 'Single-Cell RNA-Seq Analysis', questions: ['sampleCount', 'organism'] as const },
  'genomic-analysis': { name: 'Genomic Analysis (WGS/WES)', questions: ['sampleCount', 'organism'] as const },
  'molecular-docking': { name: 'Molecular Docking / Simulations', questions: [] as const },
  'other': { name: 'Other / Not Sure', questions: [] as const },
} as const;
...
const ProjectEstimatorPage: React.FC<ProjectEstimatorPageProps> = ({ onBack, setActiveTab }) => {
  ...
  const renderForm = () => (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {selectedServiceInfo && (selectedServiceInfo.questions as readonly string[]).includes('sampleCount') && (
        <div>
      ...
      {selectedServiceInfo && (selectedServiceInfo.questions as readonly string[]).includes('organism') && (
        <div>
