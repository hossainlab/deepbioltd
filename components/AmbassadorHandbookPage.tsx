...
import { BookOpen, Users, Target, Sparkles, CheckCircle, Calendar, MessageSquare, Award, FileText, Star, AlertTriangle, Phone, BarChart3, Video, PenLine, Image, Megaphone, Shield } from 'lucide-react';
    ...
    <div className="pt-0 min-h-screen bg-white">
        ...
        <div className="flex-1 min-w-0 space-y-24">
              ...
              <div className="p-8 bg-white rounded-2xl border border-slate-200">
                ...
                <ul className="space-y-3 text-slate-600">
                  {[
                    ...
                    'Referral link sharing: Use your unique referral link in all promotions so enrollments can be tracked to you.',
            ...
            <div className="p-6 bg-brand-primary/5 border-l-4 border-brand-primary rounded-r-2xl">
              ...
              <ul className="space-y-2 text-slate-600">
                {[
                  ...
                  '25 or more verified referral enrollments during the year',
              ...
              {([
                ...
                },
                {
                  ...
                  tasks: [
                    ...
                    ['Minimum 10 verified referral link clicks (Bitly/TinyURL screenshot)', 'Bitly/TinyURL dashboard screenshot'],
                ...
                },
                {
                  ...
                  tasks: [
                    ...
                    ['5 students enrolled using your referral link', 'Verified via admin Bitly dashboard'],
                ...
                },
                {
                  ...
                  tasks: [
                    ...
                    ['15 or more cumulative verified referral enrolments', 'Admin-side verification'],
                ...
                },
                {
                  ...
                  tasks: [
                    ...
                    ['25 or more cumulative verified referral enrolments', 'Admin-side verification'],
          ...
          <section id="marketing">
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  {[
                    ...
                    ['Referral link shared in posts', 'Every post must include your link'],
                    ['Bitly dashboard screenshot submitted', '1 per month'],
                  ].map(([activity, min], i) => (
                    <tr key={i} className="hover:bg-slate-50">
            ...
            <ul className="space-y-3 text-slate-600">
              {[
                ...
                'Do not ask people to click your link just to inflate your Bitly count — only genuine sharing counts.',
              ].map((item, i) => (
          ...
          <section id="content">
            ...
            <div className="mt-6 p-5 bg-brand-primary/5 border border-brand-primary/20 rounded-2xl text-sm text-slate-700">
              ...
              <strong>Tip:</strong> Ambassadors who post video content consistently tend to score 15–20% higher on their monthly evaluations and report more referral enrolments from their personal network.
            </div>
          </section>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  {[
                    ...
                    ['Bitly dashboard screenshot', 'Upload to Google Drive, paste link (shows your click count)'],
          ...
          <section id="scoring">
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  {[
                    ...
                    ['Referral link clicks (verified via Bitly/TinyURL)', '20 points'],
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-4">Referral Scoring Detail</h3>
            <div className="rounded-2xl border border-slate-200 overflow-hidden">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200">
                    <th className="text-left px-6 py-3 font-semibold text-slate-700">Referral Performance</th>
                    <th className="text-left px-6 py-3 font-semibold text-slate-700">Points</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                  {[
                    ['0–4 clicks, 0 enrollments', '0–5 points'],
                    ['5–14 clicks, 1–2 enrollments', '6–12 points'],
                    ['15–29 clicks, 3–4 enrollments', '13–17 points'],
                    ['30+ clicks or 5+ enrollments', '18–20 points'],
                  ].map(([perf, pts], i) => (
                    <tr key={i} className="hover:bg-slate-50">
              ...
              <div className="p-6 bg-green-50 rounded-2xl border border-green-100">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Use your unique referral link in every post that promotes DeepBio',
              ...
              <div className="p-6 bg-red-50 rounded-2xl border border-red-100">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Ask students to click your referral link without genuine interest — click farming is detectable',
      ...
      <section className="py-24 bg-brand-dark text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">Thank You for Being Part of DeepBio Academy</h2>
