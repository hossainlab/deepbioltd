        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid lg:grid-cols-2 gap-20 items-center py-24">
          <div className="space-y-12">
            ...
            <h1 className="text-6xl md:text-8xl font-bold text-white leading-[0.95] tracking-tight">
              Our <br />
              <span className="brand-text-gradient">Publications.</span>
            </h1>
            <p className="text-2xl text-slate-300 max-w-xl leading-relaxed font-light">
              Peer-reviewed research contributions advancing the frontiers of bioinformatics, genomics, and computational medicine.
            </p>
          </div>
              ...
              <div className="relative z-10 w-full px-16 space-y-10">
                ...
                <div className="p-8 glass rounded-[2.5rem] border-white/20 shadow-[0_25px_60px_rgba(0,0,0,0.7)] transform translate-x-12 -translate-y-8 hover:translate-y-[-12px] transition-all duration-700">
                  <div className="flex items-center gap-5 mb-6">
                    ...
                    <div>
                      <div className="text-slate-800 font-extrabold text-lg">Publication Count</div>
                      <div className="text-emerald-600 text-[11px] font-bold uppercase tracking-[0.2em]">Peer-Reviewed Research</div>
                    </div>
                  </div>
                  <div className="flex gap-2 items-center text-slate-600">
                    <Activity className="w-5 h-5 text-emerald-500 animate-pulse" />
                    <span className="text-xs font-bold uppercase tracking-widest">{publications.length} Papers Published</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mb-20">
            <div className="space-y-4 text-center">
              ...
              <p className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight">
                Published <span className="brand-text-gradient">Research</span>
              </p>
            </div>
          </div>
